  ...
  return (
    <div>
      ...
      <div className='flex flex-col items-center justify-center h-[500px] pt-10 space-y-4'>
        ...
        <p className='text-sm text-center text-slate-400  '>Please Drop Your Email Below To Get Daily Updates About What We Do</p>
        <form action="" className='!mt-3 sm:w-[350px] md:w-[520px] border-[3px] border-slate-500 rounded-xl flex justify-between '>
          <input type="text" placeholder='Enter your Email Address' className='p-2 border-none w-full'/>
      ...
      <div className='w-full bg-black md:-[600px] py-10'>
        <div className='w-[95%] md:w-[90%] mx-auto md:flex md:justify-evenly !md:items-center space-y-5'>
          ...
          {/* section-2  */}
          <div className="md:w-[30%] space-y-2 md:h-80">
        ...
        <p className="text-white md:ml-[7%] ">Copyright Design 2023</p>
      </div>
    </div>
    </div>
  )
